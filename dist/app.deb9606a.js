...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../assets/works-projects/Cube(3D)/app.js":[function(require,module,exports) {
var x = 0,
    bool = false,
    interval;
...
var rotate = function rotate() {
  ...
  Array.from(cubes).forEach(function (cube) {
    return cube.style.transform = "rotateY(".concat(x, "deg)");
  });
};

var changePlayPause = function changePlayPause() {
  var i = document.querySelector('.play-pause i');
  var cls = i.classList[1];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../assets/works-projects/Cube(3D)/app.js"], null)
//# sourceMappingURL=/app.deb9606a.js.map